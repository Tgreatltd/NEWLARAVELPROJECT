<div class="">
    ...
    <div class="container max-w-screen mx-auto">
        <div class="flex flex-wrap justify-between">
            ...
            <div class="w-full sm:w-1/3 md:w-1/4 lg:w-1/4 h-[55vh]  mb-4 p-4">
                <a href="{{url('storyline/'.$user->id)}}" wire:navigate>
                    ...
                    <div class="container bg-gray-800" style="margin-bottom:10px;height:50px;width: 100%;"><h1 class="text-white">{{$user->title}}</h1></div>
